...
namespace MoDueler.Nodes {
    ...
    public class HandCard : InteractableArea, IComparable<HandCard> {
        ...
        public static HandCard CreateNewHandCard(string cardIndex, Image border, Shader shader) {
            ...
            var sprite = SpriteCreator.CreateRectAreaSprite<HandCard>(cardIndex, border, ResourceFiles.MaterialFromShader(shader));
            ...
            sprite.Collider = sprite.GetNode("Collider") as CollisionShape2D;
            sprite.Renderer = sprite.GetNode("Renderer") as Sprite;
            return sprite;
        }
