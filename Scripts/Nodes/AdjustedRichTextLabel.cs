...
public class AdjustedRichTextLabel : RichTextLabel {
    ...
    public override void _Ready() {
        BbcodeEnabled = true;
        GetVScroll().RectScale = new Vector2(0, 0);
        ScrollActive = false;
    ...
    /// </summary>
    public void PreTag(string tag) {
        BbcodeText = tag + BbcodeText;
    }
